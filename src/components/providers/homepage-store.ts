...
export const DEFAULT_HOMEPAGE_CONFIG: HomepageConfig = {
  announcement: {
    ...
    items: [
      ...
      { en: "Cash on Delivery available · Vodafone Cash · InstaPay", ar: "الدفع عند الاستلام متاح · فودافون كاش · إنستا باي", visible: true },
    ],
  },
  hero: {
    visible: true,
  ...
  faq: {
    ...
    items: [
      ...
      { qEn: "What payment methods do you accept?", qAr: "ما طرق الدفع المقبولة؟", aEn: "We accept Cash on Delivery (nationwide except Red Sea), Vodafone Cash, and InstaPay. All payment methods are in Egyptian Pounds (EGP).", aAr: "نقبل الدفع عند الاستلام (في كل مكان ما عدا البحر الأحمر)، فودافون كاش، وإنستاباي. جميع المدفوعات بالجنيه المصري.", visible: true },
