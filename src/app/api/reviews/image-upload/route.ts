/**
 * POST /api/reviews/image-upload — server-mediated upload for a photo a
 * customer attaches to their review. Unauthenticated by design (reviews can
 * be submitted anonymously), same pattern as
 * /api/checkout/payment-proof-upload — abuse is bounded by rate limiting
 * plus file type/size validation rather than a session requirement.
 */
