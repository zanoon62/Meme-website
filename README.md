...
1. Clone the repo
   ```bash
   git clone https://github.com/zanoon62/Meme-website.git
   cd Meme-website
   npm install
   ```
...
2. Copy env file
   ...
   # Fill in your Supabase + ZAI keys
   ```
...
4. Access admin panel at `/admin/login`
   - Username: `admin`
   - Password: `admin123`
   - (Change these in `src/lib/auth/simple-auth.ts` for production)
...
git branch -M main
git remote add origin https://github.com/zanoon62/Meme-website.git
